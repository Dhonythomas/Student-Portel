...
async function Getotp() {
    ...
    if (currentRole === "student") {
        ...
        let staffname = document.querySelector('input[name="staffname"]').value.trim();
        let staffid = document.querySelector('input[name="staffid"]').value.trim();
        ...
        .then(data => {
            if (data.status === 'success' && data.data) {
                ...
                if (currentRole === "student") {
                    ...
                    document.querySelector('input[name="year"]').value = fields.year || '';
                    document.querySelector('input[name="semester"]').value = fields.semester || '';
                    ...
                    document.querySelector('input[name="staffphonenumber"]').value = fields.PhnNo || '';
